{if $messageResult  =='true' }
    ...
    {* <div class="alert alert-success" role="alert">
         <p class="alert-text">Merci pour votre commentaire ! </p>
     </div>*}
    ...
    <div class="comment-row-container">
        ...
        {foreach from=$comments item=element}
            <div class="comment-body">
                <div class="comment-date p-date" data-createdat="{$element.created_at}"></div>

                <div class="flex">
                    <div class="comment-author">
                        <a href="mailto:{$element.email}">{$element.username}</a>
                    </div>
